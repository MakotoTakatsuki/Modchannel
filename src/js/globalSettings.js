...
globalSettings.init = function() {
  ...
  globalSettings.siteSettingsRelation = {
    ...
    hashcashDifficultyField : {
      setting : 'hashcashDifficulty',
      type : 'string'
    },
    hashcashMemoryCostField : {
      setting : 'hashcashMemoryCost',
      type : 'string'
    },
    hashcashTimeCostField : {
      setting : 'hashcashTimeCost',
      type : 'string'
    },
    hashcashParallelismField : {
      setting : 'hashcashParallelism',
      type : 'string'
    },
    initialBypassMaxPostsField : {
      setting : 'initialBypassMaxPosts',
      type : 'string'
    },
    hashcashThrottleField : {
      setting : 'hashcashThrottle',
      type : 'string'
    }
  };
...
globalSettings.save = function() {
  ...
  for ( var key in globalSettings.siteSettingsRelation) {
    ...
    if (!document.getElementById(key)) {
      console.log('Element with id ' + key + ' cannot be found on the page!');
      continue;
    }
